...
// Halaman SplashScreen untuk pengecekan awal
...
class _SplashScreenState extends State<SplashScreen> {
  ...
  void initState() {
    super.initState();
    _navigateBasedOnRegistration();
  }

  Future<void> _navigateBasedOnRegistration() async {
    ...
    Future.delayed(const Duration(seconds: 2), () {
      if (isRegistered) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => DashboardPage(userName: userName, userId: userId),
          ),
        );
      } else {
        Navigator.pushReplacement(
